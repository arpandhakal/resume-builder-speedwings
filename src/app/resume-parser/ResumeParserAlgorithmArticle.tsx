  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the Speed Wings Resume Buidler
      ...
      <Paragraph>
        And that is everything about the Speed Wings Resume Builder parser algorithm :)
      </Paragraph>
      <Paragraph>
