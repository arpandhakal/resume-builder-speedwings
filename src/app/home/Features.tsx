...
const FEATURES = [

  {
    ...
    text: "Speed ings Resume Builder has built-in best practices for theEurope and Middle East job market and works well with top ATS platforms such as Greenhouse and Lever",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "Speed Wings Resume Builder stores data locally in your browser so only you have access to your data and with complete control",
  },
