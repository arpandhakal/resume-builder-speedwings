...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Finding the right candidates was always a challenge until we partnered with SpeedWings. Their staffing solutions and attention to detail have significantly improved our hiring process.",
    name: "Mr. Sharma",
    title: "HR Manager",
    sector: "IT Company",
  },
